(function () {
    ...
    function AuthenticationService($http, $localStorage,ConfigFactory) {
        ...
        function LoginOauth(username, password, callback) {
            
            console.log("hello");
            
            ///api/authenticate
            //http://localhost:3000/login
            $http.get(ConfigFactory.baseAppUrl + 'login/federated/google', { email: username, password: password }) //knote: dont forget to add http in url while testing locally with nodejs running separately and ui from brackets
